export const data = [
    {
        id: 'amanecer-en-vuelo',
        name: 'Amanecer en vuelo',
        principalImage: 'https://www.artesust.com.ar/ImageSabrinaRecortadas/AmanecerVuelo/AmanecerVuelo1.jpg',
        secondImage: 'https://www.artesust.com.ar/ImageSabrinaRecortadas/AmanecerVuelo/AmanecerVuelo2.jpg',
        thirdImage: 'https://www.artesust.com.ar/ImageSabrinaRecortadas/AmanecerVuelo/AmanecerVuelo3.jpg',
        fourthImage: 'https://www.artesust.com.ar/ImageSabrinaRecortadas/AmanecerVuelo/AmanecerVuelo4.jpg',
        fifthImage: 'https://www.artesust.com.ar/ImageSabrinaRecortadas/AmanecerVuelo/AmanecerVuelo5.jpg',
        description: 'Esta obra fue realizada a pedido, pautando la paleta de colores, materiales y sabiendo que iban a colocarla en el living de la casa, espacio de reunión familiar. Con eso en mente, y completa libertad para crear, me dejé llevar por lo que sentía y decidí hacer un paisaje abstracto. Para simbolizar las raíces, libertad y energía, incluí 5 aves volando hacia el brillo del sol, para plasmar en el mensaje de la obra a los 5 hijos de la familia.\nLa creación de esta obra demuestra que ya sea por impulso propio o siguiendo consignas de clientes, el arte puede nacer con plena libertad, siempre dejando un mensaje y sensaciones sobre el lienzo.',
        englishDescription: 'This artwork was created on commission, establishing the color palette and materials, and knowing that it would be placed in the living room of the home, a space for family gatherings. With this in mind, and with complete creative freedom, I allowed myself to be guided by what I felt and decided to create an abstract landscape. To symbolize roots, freedom, and energy, I included five birds flying toward the glow of the sun, representing in the message of the artwork the five children of the family.\nThe creation of this piece demonstrates that whether driven by personal impulse or guided by client instructions, art can be born in complete freedom, always leaving a message and sensations on the canvas.',
        technique: 'Acrílico, pintura asfáltica, aerosol y dorado a la hoja.',
        englishTechnique: 'Acrylic, asphalt paint, spray paint and gold leaf.',
    ...
    },
    {
        ...
        secondImage: 'https://www.artesust.com.ar/ImageSabrinaRecortadas/FuegoInterno/FuegoInterno2.jpg',
        thirdImage: 'https://www.artesust.com.ar/ImageSabrinaRecortadas/FuegoInterno/FuegoInterno3.jpg',
        fourthImage: 'https://www.artesust.com.ar/ImageSabrinaRecortadas/FuegoInterno/FuegoInterno4.jpg',
        fifthImage: 'https://www.artesust.com.ar/ImageSabrinaRecortadas/FuegoInterno/FuegoInterno5.jpg',
        description: 'Esta obra lleva el mensaje del peligro silencioso que existe cuando una vez apagado el incendio forestal los árboles añejos quedan encendidos por dentro, representando un riesgo inminente.\nNació para exponerla en una muestra en El Bolsón donde un grupo de artistas nos propusimos llevar mensajes sobre el peligro de los incendios en la Patagonia Argentina a través del arte.\nEs una obra que puede darle personalidad y profundidad a cualquier ambiente, y es especial para estar cerca de una ventana o puerta ya que el dorado de los anillos de la rodaja de árbol brillan con un resplandor que estremece.',
        englishDescription: 'This artwork carries the message of the silent danger that exists when, once a forest fire has been extinguished, the old trees remain burning from within, representing an imminent risk.\nIt was created to be exhibited in a show in El Bolsón, where a group of artists set out to convey messages about the danger of wildfires in Argentine Patagonia through art.\nIt is a piece that can bring personality and depth to any space, and it is especially suited to be placed near a window or door, as the golden rings of the tree slice shine with a glow that is truly striking.',
        technique: 'Acrílico, aerosol, relieves y láminas de oro.',
        englishTechnique: 'Acrylic, spray paint, reliefs and gold leafs.',
        price: 250000,
        // priceUsd: 0,
        size: '60 x 80 cm',
        dispo: true,
    ...
    },
    {
        ...
        principalImage: 'https://www.artesust.com.ar/ImageSabrinaRecortadas/LagoPatagonico/LagoPatagonico1.jpg',
        secondImage: 'https://www.artesust.com.ar/ImageSabrinaRecortadas/LagoPatagonico/LagoPatagonico2.jpg',
        thirdImage: 'https://www.artesust.com.ar/ImageSabrinaRecortadas/LagoPatagonico/LagoPatagonico3.jpg',
        fourthImage: 'https://www.artesust.com.ar/ImageSabrinaRecortadas/LagoPatagonico/LagoPatagonico4.jpg',
        fifthImage: 'https://www.artesust.com.ar/ImageSabrinaRecortadas/LagoPatagonico/LagoPatagonico5.jpg',
        description: 'La obra representa la magia de los lagos Patagónicos, con ese color turquesa que nace de la harina de glaciar; minerales suspendidos que atrapan al espectro solar y lo transforman en color. Con las texturas la obra revela la historia oculta en los lagos, esos sedimentos que guardan los secretos de milenos bajo la superficie.\nAl ver la obra es inevitable emprender un viaje mental que genera paz y tranquilidad.',
        englishDescription: 'The artwork represents the magic of the Patagonian lakes, with that turquoise color born from glacial flour; suspended minerals that capture the solar spectrum and transform it into color. Through its textures, the piece reveals the hidden history within the lakes, those sediments that hold the secrets of millennia beneath the surface.\nWhen viewing the artwork, it is inevitable to embark on a mental journey that brings peace and tranquility.',
        technique: 'Acrílico, texturas, polvo de cuarzo, pintura asfáltica y aerosol.',
        englishTechnique: 'Acrylic, textures, quartz powder, asphalt paint and spray paint.',
        price: 250000,
        // priceUsd: 0,
        size: '60 x 80 cm',
        dispo: true,
